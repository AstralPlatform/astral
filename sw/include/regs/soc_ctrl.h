...
#define CARFIELD_STREAMER_CLK_DIV_ENABLE_REG_OFFSET 0xfc
#define CARFIELD_STREAMER_CLK_DIV_ENABLE_STREAMER_CLK_DIV_ENABLE_BIT 0

// Streamer clock divider value
#define CARFIELD_STREAMER_CLK_DIV_VALUE_REG_OFFSET 0x100
#define CARFIELD_STREAMER_CLK_DIV_VALUE_STREAMER_CLK_DIV_VALUE_MASK 0x3f
#define CARFIELD_STREAMER_CLK_DIV_VALUE_STREAMER_CLK_DIV_VALUE_OFFSET 0
#define CARFIELD_STREAMER_CLK_DIV_VALUE_STREAMER_CLK_DIV_VALUE_FIELD \
  ((bitfield_field32_t) { .mask = CARFIELD_STREAMER_CLK_DIV_VALUE_STREAMER_CLK_DIV_VALUE_MASK, .index = CARFIELD_STREAMER_CLK_DIV_VALUE_STREAMER_CLK_DIV_VALUE_OFFSET })

// Streamer general interrupt
#define CARFIELD_STREAMER_GENERAL_IRQ_REG_OFFSET 0x104
#define CARFIELD_STREAMER_GENERAL_IRQ_STREAMER_GENERAL_IRQ_BIT 0

// SpaceWire general interrupt
#define CARFIELD_SPW_GENERAL_IRQ_REG_OFFSET 0x108
#define CARFIELD_SPW_GENERAL_IRQ_SPW_GENERAL_IRQ_BIT 0
